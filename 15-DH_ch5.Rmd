...
df_loss %>% 
  dplyr::select(sex,
                ...
                "Food Intake" = diet,
                "Metabolic Rate" = meta) %>% 
  apaSupp::tab1(caption = "Descriptive of Continuous Measures by Sex",
                split = "sex",
                total_last = FALSE,
                p_note = NA,
                type = list("Weight Loss"        = "continuous",
                            "Exercise Frequency" = "continuous",
                            "Food Intake"        = "continuous",
                            "Metabolic Rate"     = "continuous")) %>% 
  flextable::bg(i = 1:2, j = 3, bg = "lightblue") %>% 
  flextable::bg(i = 1:2, j = 4, bg = "lightpink")
```
