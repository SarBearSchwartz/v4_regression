...
```{r vanmarterbpddata}
bpd_raw <- read.table("https://raw.githubusercontent.com/CEHS-research/eBook_regression/master/data/VanMarter_%20BPD.txt?token=AScXBVyjzC2aVyRyOL9NHJYxjEfsjys_ks5b2jSIwA%3D%3D", 
                      header      = TRUE, 
                      strip.white = TRUE)
```
