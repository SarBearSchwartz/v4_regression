...
To assess the potential relationship between both these beliefs and depressive symptoms, first Pearson correlations were computed.  Multiple linear regression was used to further investigate the hypothesized association between simplicity and depression after controlling for the previously shown correlation between fatalism and depression.
...
Depressive Symptoms were  positively correlated with both fatalism beliefs, *r* = .660, *p* < .001, and simplicity beliefs, *r* = .640, *p* <.001. A similar degree of correlation was manifest between the two types of belief, *r* = .630, *p* < .001.

**...need to write up the regression now...**
...
apaSupp::tab_lms(list(fit_lm_sim, fit_lm_fat, fit_lm_both),
                 ...
                 var_labels = c("simplicity" = "Simplicity",
                                "fatalism"   = "Fatalism"),
                 caption = "Parameter Estimates for Models Regressing Depressive Symptoms on Belief Scores",
