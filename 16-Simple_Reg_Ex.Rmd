...
```{r}
performance::check_residuals(fit_lm_sim)
```

```{r}
ggResidpanel::resid_panel(fit_lm_sim)
```
...
```{r}
performance::check_residuals(fit_lm_fat)
```


```{r}
ggResidpanel::resid_panel(fit_lm_fat)
```
