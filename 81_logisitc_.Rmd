...
```{r lowbwtdata}
lowbwt_raw <- read.table("https://raw.githubusercontent.com/CEHS-research/eBook_regression/master/data/lowbwt.txt?token=AScXBX3XmT-nIoQBId69bcTIRufcPgeqks5b2jTVwA%3D%3D", 
                         header = TRUE, 
                         sep = "", 
                         na.strings = "NA", 
                         dec = ".", 
